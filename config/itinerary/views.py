...
def itinerary_detail(request, pk: int):
    ...
    return render(request, "itinerary/detail.html", {"itinerary": itinerary, "events": events})
    ...
    if request.method == "POST":
        ...
        if action == "save" and not request.user.is_authenticated:
            ...
            try:
                ...
                return redirect("itinerary:preview")
    else:
        form = ItineraryForm()

    return render(request, "itinerary/form.html", {"form": form, "is_edit": False})
...
def edit_itinerary(request, pk: int):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("itinerary:detail", pk=updated_itinerary.pk)
    else:
...
def preview_itinerary(request):
    ...
    return render(request, "itinerary/preview.html", context)
