...
from .car_rentals import CarRentalSearchError, search_car_rentals_natural
from .eventbrite import fetch_events
from .flights import FlightSearchError, search_flights_natural
from .forms import CarRentalSearchForm, FlightSearchForm, ItineraryForm, ItineraryUpdateForm
from .models import CarRentalResult, CarRentalSearch, FlightResult, FlightSearch, Itinerary
...
def car_rental_search(request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                if request.user.is_authenticated:
                    ...
                    return redirect("core:car_rental_results", pk=search_obj.pk)

                # Anonymous: render results inline
                return render(request, "core/car_rental_results.html", {
                    "params": params,
                    "listings": listings,
                    "search": None,
                })
    ...
    return render(request, "core/car_rental_search.html", {"form": form})
